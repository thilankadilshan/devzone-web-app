...
// --- ALL SOCIAL PLATFORMS DATA WITH REAL BRAND COLORS ---
...
export default function ContactContent() {
  ...
  return (
    <div ref={containerRef} className={styles.contactPage}>
      {/* Background Ambient Glows to break up the black */}
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroBgWrap}>
          {/* Ensure you have an image at public/images/contact-bg.jpg */}
          <img
        ...
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            ...
            about the latest F1 race? Drop me a message below.
          </p>
        </div>
      </section>

      {/* --- YOUR EXACT CONTACT COMPONENT --- */}
      {/* It will render your form, WhatsApp button, rocket animation, etc., exactly as you coded it */}
      ...
      <section className={styles.socialSection}>
        <div className={styles.sectionHeader}>
          ...
          <p>Connecting across the digital landscape.</p>
        </div>
          ...
          {socialPlatforms.map((platform, index) => (
            ...
            >
              <div className={styles.cardTop}>
                {/* INJECTING THE REAL ICON COLOR HERE */}
                <div
